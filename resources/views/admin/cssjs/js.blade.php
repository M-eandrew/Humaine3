<script src="admindash/assets/js/core/popper.min.js"></script>
  <script src="admindash/assets/js/core/bootstrap.min.js"></script>
  ...
  <script>
    ...
    if(ctx){
      var chart_bars = echarts.init(ctx);
      chart_bars.setOption({
        color: ['#3398DB'],
        tooltip: {
            trigger: 'axis',
            axisPointer: {            
  ...
  <script src="admindash/assets/js/material-dashboard.min.js?v=3.0.4"></script>
